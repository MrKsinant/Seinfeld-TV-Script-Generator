...
def test_create_lookup_tables(create_lookup_tables):
    ...
    # Compare lengths of dictionaries:
    ...
    # Make sure the dictionaries have the same words:
    ...
    # Make sure the dictionaries have the same word ids:
    ...
    # Make sure the dictionaries make the same lookup:
